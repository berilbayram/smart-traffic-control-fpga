...
set_property PACKAGE_PIN U14 [get_ports {is_done}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {is_done}]
#set_property PACKAGE_PIN V14 [get_ports {led_am2}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {led_am2}]
#set_property PACKAGE_PIN V13 [get_ports {led_am3}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {led_am3}]
...
##Sch name = JA9
#set_property PACKAGE_PIN H2 [get_ports {red3}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {red3}]
##Sch name = JA10
#set_property PACKAGE_PIN G3 [get_ports {yellow3}]					
...
set_property PACKAGE_PIN A14 [get_ports {sensor_trigger1}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sensor_trigger1}]
#Sch name = JB2
set_property PACKAGE_PIN A16 [get_ports {sensor_echo1}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sensor_echo1}]
##Sch name = JB3
set_property PACKAGE_PIN B15 [get_ports {sensor_trigger2}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sensor_trigger2}]
##Sch name = JB4
set_property PACKAGE_PIN B16 [get_ports {sensor_echo2}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sensor_echo2}]
##Sch name = JB7
set_property PACKAGE_PIN A15 [get_ports {sensor_trigger3}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sensor_trigger3}]
##Sch name = JB8
set_property PACKAGE_PIN A17 [get_ports {sensor_echo3}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sensor_echo3}]
##Sch name = JB9
#set_property PACKAGE_PIN C15 [get_ports {green3}]					
...
set_property PACKAGE_PIN K17 [get_ports {rfid_1}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {rfid_1}]
##Sch name = JC2
#set_property PACKAGE_PIN M18 [get_ports {rfid_2}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {rfid_2]}]
##Sch name = JC3
set_property PACKAGE_PIN N17 [get_ports {rfid_2}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {rfid_2}]
##Sch name = JC4
set_property PACKAGE_PIN P18 [get_ports {rfid_3}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {rfid_3}]
##Sch name = JC7
...
set_property PACKAGE_PIN P17 [get_ports {green3}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {green3}]
##Sch name = JC10
#set_property PACKAGE_PIN R18 [get_ports {green3}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {green3}]
